...
// the watchOS floor was 27 the wildcard was equivalent — "available at the
// deployment target" and the deployment target was 27. Dropping that floor to
// 26 (DECISIONS.md 2026-08-12) made the difference load-bearing: the wildcard
// then claimed availability from watchOS 26, while every `NowPlaying` symbol
// this type touches is watchOS 27+, and the watch build failed with six errors.
