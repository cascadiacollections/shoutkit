...
extension PlaybackController {
    ...
    func handleTrackInfo(_ info: AudioTrackInfo) {
        ...
        // An ad break: clear the track/art surface and flag the state so the
        // Now Playing screen can offer an ambient fallback. Don't run the
        // dedup/resource path — there's no track to resolve.
