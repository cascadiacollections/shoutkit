    ...
    @MainActor
    final class HolmdelCarPlaySceneDelegate: UIResponder, CPTemplateApplicationSceneDelegate {
        private enum Limits {
                    ...
                    CPListSection(
                        items: [
                            CPListItem(
                                ...
                                detailText: "Open Holmdel on iPhone to start listening or add favorites.",
                            ),
                        ],
                        header: nil,
                        sectionIndexTitle: nil,
        ...
        private func topStationItems(
            ...
            case .loading:
                [CPListItem(text: "Loading Top Stations…", detailText: nil)]
            case .unavailable:
                [
                    CPListItem(
